...
class MongoDb extends Datasource {
  /**
   * Fenerates the find object for a mongodb query
   * 
   * @param {object} options
   */
  buildFindObject ({ modifiedAfter }) {
    const findObject = {}
    findObject[this.modifiedField] = modifiedAfter ? {$gt: modifiedAfter} : undefined
    return findObject
  }
  ...
  buildMongoSshCommand ({ modifiedAfter, offset }) {
    ...
    const limitString = this.paginationPageSize ? `.limit(${this.paginationPageSize})` : ''
