...
class Datasource {
   ...
   */
  constructor ({ name, type, cache, location, idField, privateSshKey, pagination }) {
   ...
   */
  async syncDatasource ({ modifiedAfter, limit } = {}) {
    ...
    do {
      ...
      const page = await this.queryDatasource({ modifiedAfter, limit, offset })
      result.push(...page)
